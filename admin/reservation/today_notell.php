<?php include_once("../library/reservation/today_notell.php");?>
	...
	<div id="page-heading">
		...
		<h1>
			...
			<span style="margin-left:20px;">
				...
				<input type="checkbox" name="rsv_today" value=1 <?php if($_POST['rsv_today']) echo "checked";?> /><font size=2>当日予約(予約日、登録日が当日のお客様)</font>
...
//	while ( $data = $dRtn3->fetch_assoc() ) {
	while ( $data = $dRtn3->fetch() ) {
		...
		echo 	'<td>'.$gTodayStatus[$data['today_status']].'</td>';
		echo 	'<td>'.$data['today_cnt'].'</td>';

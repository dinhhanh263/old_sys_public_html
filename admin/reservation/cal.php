									...
									<td>
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												...
												<td><input type="text" name="usered_price" value="<?php echo $usered_price ;?>" class="inp-form" /></td>
											</tr>
											<tr>
												<td>========================</td><td>=============================</td>
											</tr>
											<tr>
												<th valign="top">残金:</th>
												<td><input type="text" name="payment" value="<?php echo $sales['id'] ? $sales['payment'] : (0-$remained_price) ;?>" class="inp-form" /></td>
											</tr>

											<tr>
												<th valign="top">手数料:</th>
												<td><input type="text" name="charge" value="<?php echo $charge ;?>" class="inp-form" /></td>
											</tr>
											<tr>

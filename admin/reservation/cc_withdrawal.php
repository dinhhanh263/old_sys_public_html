...
if( $_REQUEST['contract_id'] ) {
	$data = Get_Table_Col("sales","max(option_date)"," WHERE del_flg=0 AND type=8 AND (option_price+option_transfer+option_card)>0 AND contract_id = '".addslashes($_REQUEST['contract_id'])."' GROUP BY customer_id");
}
?>
							...
							<tr valign="top">
								<td>
									...
									<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
										...
										<tr>
											<th valign="top">名前:</th>
											<td><?php echo $_REQUEST['name'];?></tdd
										</tr>
										<tr>
											<th valign="top">引落種別:</th>
											<td><?php echo $gPayType3[$_REQUEST['pay_type']];?></tdd
										</tr>
										<tr>
											<th valign="top">最終引落日:</th>
											<td><?php echo $data;?></td>
										</tr>
									</table>
									</div>

...
<div id="content-outer">
	<!-- start content -->
	<div id="content">
		<div id="page-heading"><h1>コース詳細</h1></div>
								...
								<td>
									...
									<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												<th valign="top">通いホーダイ:</th>
												<td>
													<input type="checkbox" name="zero_flg" value="1" <?php if($data['zero_flg']) echo "checked";?> class="form-checkbox" />
												</td>
											</tr>											
											<tr>
												<th valign="top">新月額:</th>
												<td>
													<input type="checkbox" name="new_flg" value="1" <?php if($data['new_flg']) echo "checked";?> class="form-checkbox" />
												</td>
											</tr>
											<tr>
												<th valign="top">備考:</th>

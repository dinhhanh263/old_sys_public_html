							...
							<tr valign="top">
								<td>
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												<th valign="top">名前:</th>
												<td><?php echo $data['name'];?>( <?php echo $data['name_kana'];?> )</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<?php echo ($course_type[$contract['course_id']] ? $gContractStatus3[$contract['status']] : $gContractStatus[$contract['status']]);?>
													...
													<?php echo ($course_type[$contract['course_id']]&&$contract['start_ym'] ? '<br />'.'(施術開始:'.date('Y/m～',strtotime($contract['start_ym'].'01')).')': '');?>
												</td>
											</tr>
											<tr>
												<th valign="top">施術タイプ:</th>
												<td><?php echo $gtreatmentType[$course_treatment_type[$contract['course_id']]];?></td>
											</tr>
											<tr<?php echo $course_new_flg[$contract['course_id']] ==1 ? ' class="new_monthly"' : '' ; ?>>
											...
											<tr>
												...
												<td><?php echo $shop_list[$contract['shop_id']];?></td>
											</tr>
											<?php }else{?>
											<tr>

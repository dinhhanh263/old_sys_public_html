<?php include_once("../library/customer/loan_cancel.php");?>
	...
	<div id="page-heading">
		<h1>
			...
			<span style="margin-left:20px;">
				<a href="./loan_cancel.php?contract_date=<?php echo $pre_date?>&shop_id=<?php echo $_POST['shop_id'];?>"><img src="../images/table/paging_left.gif" title="前日" /></a>
				...
				<a href="./loan_cancel.php?contract_date=<?php echo $next_date?>&shop_id=<?php echo $_POST['shop_id'];?>"><img src="../images/table/paging_right.gif" title="翌日" /></a>

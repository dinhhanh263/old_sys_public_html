<?php include_once("../library/customer/balance.php");?>
...
<script type="text/javascript">
function display () {
    document.search.action = "balance.php";
...
function csv_export () {
    ...
    img.src = path;
    img.onload = function() {
      document.search.action = "balance_csv.php";
	  document.search.submit();
	...
	<div id="page-heading">
		<h1>
			...
			<span style="margin-left:20px;">
				<a href="./balance.php?contract_date=<?php echo $pre_date?>&shop_id=<?php echo $_POST['shop_id'];?>"><img src="../images/table/paging_left.gif" title="前日" /></a>
				...
				<a href="./balance.php?contract_date=<?php echo $next_date?>&shop_id=<?php echo $_POST['shop_id'];?>"><img src="../images/table/paging_right.gif" title="翌日" /></a>

<?php include_once("../library/service/conversion.php");?>
...
function keisan(){
    ...
    var price = course_price[course_id] - discount - payed_price;										// 請求金額（税込）=コース金額-値引き-支払済金額
...
<div id="content-outer">
	<!-- start content -->
	<div id="content">
		<div id="page-heading"><h1>プラン組替処理<?php if ($_POST['nosubmit_flg']) { echo "（金額確認用）"; } echo ($gMsg) ;?></h1></div>
					...
					<div id="content-table-inner">
							...
							<tr valign="top">
								...
								<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
									...
									<input type="hidden" name="r_times" value="<?php echo $data['r_times'];?>" />
									<input type="hidden" name="latest_date" value="<?php echo $data['latest_date'];?>" />
									<input type="hidden" name="conversion_flg" value="1" />
									<td>
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<input type="hidden" name="discount" value="<?php echo TA_Cook($new_contract['discount']) ;?>" /></td>
											<tr>
										...
										<div id="related-activities">
											...
											<div id="related-act-bottom">
												...
												<div id="related-act-inner">
													...
													<div class="right">
														<h5>
															<a href="javascript:void(0);" onclick="window.open('../pdf/pdf_out3.php?sales_id=<?php echo $sales['id'];?>', 'mywindow4', 'width=900, height=1000, menubar=no, toolbar=no, scrollbars=yes');" style="font-weight:bold;color:#94b52c;" onmouseover="this.style.color='#393939'" onmouseout="this.style.color='#94b52c'" title="領収書発行へ">領収書</a>
														</h5>
													</div>
													<div class="clear"></div>
													<div class="lines-dotted-short"></div>
													...
													<div class="right">
														...
														<a href="javascript:void(0);" onclick="window.open('../pdf/pdf_out_conversion3.php?contract_id=<?php echo $new_contract['id'];?>', '_blank', 'width=900, height=1000, menubar=no, toolbar=no, scrollbars=yes');" class="side" >プラン組替通知書</a>
														<?php } elseif( $new_course['interval_date'] != null && $new_course['sales_start_date'] >= '2019-11-06'){ ?>
														<a href="javascript:void(0);" onclick="window.open('../pdf/pdf_out_conversion2.php?contract_id=<?php echo $new_contract['id'];?>', '_blank', 'width=900, height=1000, menubar=no, toolbar=no, scrollbars=yes');" class="side" >プラン組替通知書</a>
														<?php } else { ?>
														<a href="javascript:void(0);" onclick="window.open('../pdf/pdf_out_conversion.php?contract_id=<?php echo $new_contract['id'];?>', 'mywindow4', 'width=900, height=1000, menubar=no, toolbar=no, scrollbars=yes');" style="font-weight:bold;color:#94b52c;" onmouseover="this.style.color='#393939'" onmouseout="this.style.color='#94b52c'" title="プラン組替通知書">プラン組替通知書</a>
														<?php } ?>
														</h5>
													</div>
													<div class="clear"></div>

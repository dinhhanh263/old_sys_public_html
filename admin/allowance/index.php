	...
	<div id="page-heading">
		...
		<h1>
			...
			<span style="margin-left:20px;">
				...
				<select name="staff_id"  style="height:25px;"><?php Reset_Select_Array_Group( getDatalistArray("staff","shop_id") , $_POST['staff_id'] ? $_POST['staff_id'] : $data['staff_id'],getDatalist5("shop",$_POST['shop_id']));?></select>

			...
			<div id="table-content">
				<!--  start product-table ..................................................................................... -->
				  <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
					...
					<tr>
                                          <form action="" method="post" name="frm31">
                                                <td>31</td>
                                                <td>労務</td>
                                                <td>寺岡</td>
                                                <td>物販インセンティブ</td>
                                                ...
                                                <td><input class="inp-form" type="text" name="date1" value="<?php echo date(j)<10 ? date("Y-m",strtotime("-2 month")) : date("Y-m",strtotime("-1 month")); ?>" /></td>
                                                <td></td>
                                                <td><input type='button' value='　CSV　' onclick='csv_export(31);' style="height:25px;" /></td>
                                          </form>
                                        </tr>
					<tr>
                                          <form action="" method="post" name="frm32">
                                                <td>32</td>
                                                <td>労務</td>
                                                <td>寺岡</td>
                                                <td>社販インセンティブ</td>
                                                ...
                                                <td><input class="inp-form" type="text" name="date1" value="<?php echo date(j)<10 ? date("Y-m",strtotime("-2 month")) : date("Y-m",strtotime("-1 month")); ?>" /></td>
                                                <td></td>
                                                <td><input type='button' value='　CSV　' onclick='csv_export(32);' style="height:25px;" /></td>
                                          </form>
                                        </tr>
					<tr>
                                          <form action="" method="post" name="frm33">
                                                <td>33</td>
                                                <td>人事</td>
                                                <td>山脇</td>
                                                <td>未成年契約者一覧</td>
                                                ...
                                                <td><input class="inp-form" type="text" name="date1" value="<?php echo date('Y-m')."-01"; ?>" /></td>
                                                <td><input class="inp-form" type="text" name="date2" value="<?php echo date('Y-m-d'); ?>" /></td>
                                                <td><input type='button' value='　CSV　' onclick='csv_export(33);' style="height:25px;" /></td>
                                          </form>
                                        </tr>
				  </table>
				<!--  end product-table................................... -->

...
if ( $dRtn3->num_rows >= 1 ) {
	echo mb_convert_encoding("id,status,契約状況,契約店舗ID,契約店舗名,customer_id,会員番号,スタッフID,スタッフ名,スタッフ番号,所属店舗ID,所属店舗名,コースID,コース名,type,times,zero_flg,new_flg,金額,契約日,解約日,支払完了日\n","SJIS-win", "UTF-8");

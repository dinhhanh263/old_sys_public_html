/*!
 * ※2016/10/17 カウンセリングレジ清算で3か月先までのカレンダーを表示させる機能が欲しかったため新規ファイルを作成 shimada※
 * 元ファイル /var/www/demo2.kireimo.biz/public_html/admin/js/jquery.ui.ympicker.js
 * 元ファイルとの変更箇所:下記記述を追加
 *  $(function(){

									...
									<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											<tr>
												...
												<td type="text" name="code"><?php echo TA_Cook($data['code']) ;?></td>
											</tr>
											<tr>
											...
											<tr>
												<th valign="top">雇用形態(新):</th>
												<td><select name="employment_type" class="styledselect_form_1"><?php Reset_Select_Key( $gEmploymentType , $data['employment_type']);?></select></td>
											</tr> 
											<tr>
												<th valign="top">職種(新):</th>
												<td><select name="job_type" class="styledselect_form_1"><?php Reset_Select_Key( $gJobType , $data['job_type']);?></select></td>
											</tr> 
											<tr>
												<th valign="top">役職(新):</th>
												<td><select name="position" class="styledselect_form_1"><?php Reset_Select_Key( $gNewStaffType , $data['position']);?></select></td>
											</tr>
											<tr>
												<th valign="top">期別:</th>
											...
											<!-- <th valign="top">身元保証人名前:</th>
												<td><input type="text" name="parent_name" value="<?php echo TA_Cook($data['parent_name']) ;?>" id="fm" class="inp-form" /></td>
											</tr>
											<th valign="top">身元保証人電話番号:</th>
												<td><input type="text" name="parent_tel" value="<?php echo TA_Cook($data['parent_tel']) ;?>" id="fm" class="inp-form" /></td>
											</tr>
											<tr>
												<th valign="top">身元保証人住所:</th>
												<td><input type="text" name="parent_address" value="<?php echo TA_Cook($data['parent_address']) ;?>" class="inp-form" /></td>
											</tr>
											<tr>

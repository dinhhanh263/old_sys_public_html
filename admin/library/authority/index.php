...
if( $_POST['action'] == "edit") {
	if($_POST['id'] != ""){
		...
		//従業員所、アカウント更新
		if($_POST['staff_id'])$GLOBALS['mysqldb']->query("update staff set auth_id='".$_POST['id']."',type='".$_POST['authority']."',login_id='".$_POST['login_id']."',password='".$_POST['password']."' where id='".$_POST['staff_id']."'") or die('query error'.$GLOBALS['mysqldb']->error);
...
if( $_POST['keyword'] != "" ){
	$dWhere = " WHERE ";
	$dWhere .= "  login_id LIKE '%".addslashes( $_POST['keyword'] )."%'";

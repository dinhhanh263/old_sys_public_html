...
if( $_POST['keyword'] != "" ){
	...
	$dWhere .= "  or name_kana LIKE '%".addslashes( $_POST['keyword'] )."%'";
	$dWhere .= "  or address LIKE '%".addslashes( $_POST['keyword'] )."%'";
	$dWhere .= "  or memo LIKE '%".addslashes( $_POST['keyword'] )."%'";
	$dWhere .= " ) ";
}
...
$dSql = "SELECT * FROM " . $table . " WHERE del_flg = 0".$dWhere." ORDER BY id DESC,rank LIMIT ".$dStart.",".$dLine_Max;

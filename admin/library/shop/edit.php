...
if( $_POST['action'] == "edit" ) {
	...
	if( !$_POST['id'] && $_POST['code'] && Get_Table_Col($table,"id"," WHERE del_flg=0 AND code ='".$_POST['code']."'" )){
		$gMsg .= '店舗コードが既に存在しています。';
	}elseif( $_POST['id'] != "" && $_POST['code'] && Get_Table_Col($table,"id"," WHERE del_flg=0 AND id<> ".$_POST['id']." AND code ='".$_POST['code']."'" )){
		$gMsg .= '店舗コードが既に存在しています。';
	}elseif($_POST['id'] != ""){

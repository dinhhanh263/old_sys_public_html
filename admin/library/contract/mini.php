...
if( $_POST['contract_id'] != "" )  {
	$sql = $GLOBALS['mysqldb']->query("select * from reservation WHERE del_flg = 0 and contract_id = '" . addslashes($_POST['contract_id']) . "' order by id DESC") or die('query error' . $GLOBALS['mysqldb']->error);

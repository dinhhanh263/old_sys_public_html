								...
								<td>
									...
									<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											<font color='red'><?php echo $gMsg; ?></font>
											<tr>
											...
											<tr>
												...
												<td><input type="text" name="vip_rooms" value="<?php echo TA_Cook($data['vip_rooms']) ;?>" id="fm" class="inp-form" /><font color="red" >*カウンセリング用</font></td>
											</tr>
											<tr>
											...
											<tr>
												<th valign="top">実際カウンセルルーム数:</th>
												<td><input type="text" name="current_c_rooms" value="<?php echo TA_Cook($data['current_c_rooms']) ;?>" id="fm" class="inp-form" /></td>
											</tr>
											<tr>
												<th valign="top">実際VIPルーム数:</th>
												<td><input type="text" name="current_vip_rooms" value="<?php echo TA_Cook($data['current_vip_rooms']) ;?>" id="fm" class="inp-form" /></td>
											</tr>
											<tr>
											...
											<tr>
												<th valign="top">機械台数:</th>
												<td><input type="text" name="machines" value="<?php echo TA_Cook($data['machines']) ;?>" id="fm" class="inp-form" /></td>
											</tr>
											<tr>

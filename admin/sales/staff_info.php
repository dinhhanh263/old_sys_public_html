...
<?php include_once("../library/sales/staff_info.php");?>
									...
									<form action="staff_info.php" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												...
												<td><?php echo $staff['shop_id']==1001 ? "本社(土日祝休)"  : "店舗";?></td>
											</tr>
											<tr>
												<th valign="top">基本給:</th>
												<td><input type="text" name="" value="200000" /></td>
											</tr>
											<tr>
												<th valign="top">役職名:</th>
												<td><?php echo ($data['type'] ? $gStaffType[$data['type']] : $gStaffType[$staff['type']] );?></td>
											</tr>
										
											<tr>
												<th valign="top">役職手当:</th>
												<td><?php echo $posi_salary['allowance']; ?></td>
											</tr>
											<tr>
												<th valign="top">所属:</th>

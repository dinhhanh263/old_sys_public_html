		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
			...
			<?php if( $_POST['action'] != "send" ) {?>
				...
				<tr>
					...
					<td><input style="width:170px;height:25px;" type="text" name="sender" value="info@kireimo.jp" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input style="width:535px;height:25px;" name="test_mail" type="text"  placeholder="info@kireimo.jp" />&nbsp;<input type="button" style=";height:28px;" class="imeoff" value="テスト送信" onclick="javascript:test_send();" /></td>
				</tr>
				<tr>
					<th valign="top">件名</th>

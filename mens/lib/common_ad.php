<?php 
// 参照元取得
if(!isset($_SESSION['MENS_KIREIMO_REFERER'])) $_SESSION['MENS_KIREIMO_REFERER']=$_SERVER['HTTP_REFERER'];

// Link-Aのsid格納
if(isset($_GET['sid'])) $_SESSION['MENS_AFFILIATE_ID']=$_GET['sid'];

// ブログ名よりADコードに変換
if(!isset($_GET['adcode']) && !isset($_SESSION["MENS_PRE_AD_CODE"])){
...
if(!isset($_GET['adcode']) && isset($_SESSION["MENS_PRE_AD_CODE"])){
		...
		$_SESSION['MENS_AD_CODE'] = Get_Table_Col("adcode","id"," where adcode='{$_SESSION['MENS_PRE_AD_CODE']}'");

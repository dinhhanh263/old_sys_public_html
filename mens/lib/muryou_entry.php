...
// Formからの登録処理
	...
	$sql = "INSERT INTO " . $table . " ( ".$sql_name."mo_agent,adcode,mo_id,session_id,url,user_agent,reg_date ) VALUES(";
	$sql .= $sql_data.$mo_agent.",'".$_SESSION['MENS_AD_CODE']."','".$mobile_id."','".session_id()."','".$_SERVER['PHP_SELF']."','".$ua."','".date("Y-m-d H:i:s"). "')";
	$rtn = $GLOBALS['mysqldb']->query( $sql );
	$id = $GLOBALS['mysqldb']->insert_id();
	$data['id'] = $id;

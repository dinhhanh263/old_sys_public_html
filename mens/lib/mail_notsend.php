...
http://kireimo.jp/minor/index.html

お客様の体質・体調・肌の状態により脱毛できる部位に制限がございます。
詳しくは下記KIREIMO公式HPをご覧ください。

http://kireimo.jp/qa/index.html

ご予約の変更・キャンセルに関しましては下記URLから変更をお願い致します。

・ご予約の変更の場合はこちら。
http://kireimo.jp/counseling/?id='.$data['customer_id'].'&rid='.$data_ID.'&act=change

・ご予約のキャンセルの場合はこちら。
http://kireimo.jp/counseling/?id='.$data['customer_id'].'&rid='.$data_ID.'&act=cancel

'.($data['name'] ? $data['name']."様の" : "").'ご来店、スタッフ一同心よりお待ち申し上げております。
...
';
			...
			// mb_send_mail($data['mail'],$subject2,$content2,$from,$returnpath);

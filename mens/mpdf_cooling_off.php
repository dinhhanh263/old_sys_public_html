...
// 契約部位の表示
if($_GET['contract_part'])$_GET['course_name'] = $_GET['course_name']."(".$_GET['contract_part'].")";
if($_GET['contract_part2'])$_GET['course_name2'] = $_GET['course_name2']."(".$_GET['contract_part2'].")";
if($_GET['contract_part3'])$_GET['course_name3'] = $_GET['course_name3']."(".$_GET['contract_part3'].")";
if($_GET['contract_part4'])$_GET['course_name4'] = $_GET['course_name4']."(".$_GET['contract_part4'].")";

$title = "取消処理明細書";


$msg = "このたびはご契約頂いた下記のプランをご解約しました。\nご確認下さいませ。宜しくお願い致します。";
...
$pdf->Cell($w2, 40, mb_convert_encoding( "￥".number_format($_GET['fixed_price']), "SJIS", "UTF-8" ), 1, 1,'R');
$pdf->SetXY( 15, 160 );
$pdf->Cell($w1, 10, mb_convert_encoding( $_GET['course_name2'], "SJIS", "UTF-8" ), 1);
$pdf->SetXY( 15, 170 );
$pdf->Cell($w1, 10, mb_convert_encoding( $_GET['course_name3'], "SJIS", "UTF-8" ), 1);
$pdf->SetXY( 15, 180 );
$pdf->Cell($w1, 10, mb_convert_encoding( $_GET['course_name4'], "SJIS", "UTF-8" ), 1);
$pdf->SetXY( 15, 190 );

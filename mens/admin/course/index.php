<?php include_once("../library/course/index.php");?>
...
<div id="content">
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>コース一覧 <a href="edit.php" style="color:#94b52c;font-size:14px;">(新規)</a></h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<th class="table-header-repeat line-left minwidth-1"><a href="">コース名</a>	</th>
					...
					<th class="table-header-repeat line-left"><a href="">旧コース</a></th>

 ...
 *
 * Copyright (c) 2006 - 2011 Jﾃｶrn Zaefferer
 *
...
$.extend($.validator, {
	...
	defaults: {
		...
		onclick: function(element, event) {
			...
			if ( element.name in this.submitted ){
				if( element.name != "birthday_y" && element.name != "birthday_m" && element.name != "birthday_d" ){
					this.element(element);
				}
			}
	...
	methods: {
		...
		email: function(value, element) {
			...
			//return this.optional(element) || /^([a-zA-Z0-9])+([a-zA-Z0-9\._-])*@([a-zA-Z0-9_-])+([a-zA-Z0-9\._-]+)+$/i.test(value);
			var domain_array = [
			...
			var domain_str = '/\.' + domain_array.join('$|\.') + '$/im';

			return this.optional(element) || /^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]{1,}\.[A-Za-z0-9]{1,}$/i.test(value) && value.match(new RegExp(".(" + domain_array.join('$|\.') + ")$", "i"));
			//return this.optional(element) || /^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]{1,}\.[A-Za-z0-9]{1,}$/i.test(value);
		},

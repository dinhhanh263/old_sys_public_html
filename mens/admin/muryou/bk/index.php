	...
	<table border="0" cellpadding="0" cellspacing="0" id="paging-table">
      ...
      <!--  end paging................ -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">最寄り駅</a></th>
...
if ( $dRtn3->num_rows >= 1 ) {
	...
	while ( $data = $dRtn3->fetch_assoc() ) {
		echo 	'<td>'.$data['entry_name'].'&nbsp;'.$data['entry_name_2'].'</td>';
		echo 	'<td>'.$data['age'].'</td>';
		...
		echo 	'<td>'.$data['line'].'線'.$data['station'].'駅</td>';
		echo 	'<td>'.$data['shop'].'</td>';

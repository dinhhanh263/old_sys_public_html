<?php include_once('../library/muryou/analyst.php');?>
	...
	<div id="page-heading">
		<h1>無料会員 広告コード別集計
			<span style="margin-left:20px;">
				<a href="./analyst.php?access_date=<?php echo $pre_date?>&agent_id=<?php echo $_POST['agent_id'];?>"><img src="../images/table/paging_left.gif" title="前日" /></a>
				...
				<a href="./analyst.php?access_date=<?php echo $next_date?>&agent_id=<?php echo $_POST['agent_id'];?>"><img src="../images/table/paging_right.gif" title="翌日" /></a>
...
if ( $data ) {
  ...
  foreach ( $data as $key=>$val ) {
	...
	$cost_cnt = "";
	if($val['maximum']<>0 ){
		$dRtn = $GLOBALS['mysqldb']->query( "SELECT sum(count) FROM accesslog WHERE page_id=4 and adcode='".$val['adcode']."' AND access_date <= '".$limit2."'");

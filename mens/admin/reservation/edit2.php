<?php include_once("../library/reservation/edit2.php");?>
<?php include_once("../include/header_menu.html");?>
 <link rel="stylesheet" href="../css/colorbox.css" />
 <script src="../js/jquery.colorbox.js"></script>
 <script>
$(document).ready(function(){
	$(".iframe").colorbox({iframe:true, opacity: 0.8, width:"90%", height:"50%"});
});
</script>
...
<div id="content-outer">
	<!-- start content -->
	<div id="content">
		<div id="page-heading"><h1>予約詳細<span style="float:right;margin-right:25px;"><a href="./edit.php?mode=new_rsv&customer_id=<?php echo $customer['id'];?>" onclick="return confirm('次の予約をしますか？')" class="side" title="次の予約" >次の予約へ</a></span></h1></div><!--予約新規?次回予約新規?予約詳細?顧客新規以外顧客情報を右側に-->
									...
									<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form" class="resev_form">
											...
											<?php if($_POST['id'] &&  $data['type']==2){?>	
												...
												<td><select name="course_id" class="styledselect_form_3" ><?php Reset_Select_Key_Group( $course_list , $contract['course_id'],$gCourseGroup);?></select></td>
										...
										<?php } ?>	
											...
											<tr>
												...
												<td><textarea name="memo2" class="form-textarea2"><?php echo TA_Cook($data['memo2']) ;?></textarea></td>
											</tr>
											<tr>
												<th valign="top">備考:</th>
											...
											<tr>
												...
												<div id="shift_min">
													<div style="padding-left:20px;"><iframe src="../main/mini.php?shop_id=<?php echo ($_POST['shop_id'] ? $_POST['shop_id'] : $data['shop_id']);?>&hope_date=<?php echo $_POST['hope_date']?>" scrolling=no height=360 width="100%"></iframe></div>
												</div>
									</form>
									<!-- end id-form  -->
								</td>
										...
										<div id="related-activities">
											...
											<div id="related-act-bottom">
												...
												<div id="related-act-inner">
													...
													<div class="right">
														<h5>
															...
															<?php if($authority_level<=1 || ($data['hope_date']==date("Y-m-d")) || ($data['hope_date']<=date('Y-m-d') && $data['status']<>1 && $data['status']<>2)){
																...
																<?php }else{ ?>
																	<a href="../service/detail.php?id=<?php echo $data['id'];?>" class="side">レジ精算</a><?php if($data['sales_id'])echo "(済)"?>
															<?php } }?>
														</h5>
														初回入金、役務消化、売掛回収等
													</div>
													...
													<div class="left"><a href=""><img src="../images/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
													<div class="right"><h5><a href="./edit.php?mode=new_rsv&customer_id=<?php echo $customer['id'];?>&shop_id=<?php echo ($_POST['shop_id'] ? $_POST['shop_id'] : $data['shop_id']);?>" onclick="return confirm('次の予約をしますか？')" class="side" >次の施術予約</a></h5></div>
													<div class="clear"></div>
													<div class="lines-dotted-short"></div>
											<?php if($authority_level<=1){?>
													<div class="left"><a href=""><img src="../images/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
											...
											<?php } ?>
													...
													<div class="left"><a href=""><img src="../images/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
													<div class="right"><h5><a href="../service/change.php?customer_id=<?php echo $customer['id'];?>&shop_id=<?php echo ($_POST['shop_id'] ? $_POST['shop_id'] : $data['shop_id']);?>"　onclick="return confirm('プラン変更をしましか？')" class="side">プラン変更</a><?php if($contract['status']==4)echo "(済)"?></h5></div>
													<div class="clear"></div>
													<div class="lines-dotted-short"></div>

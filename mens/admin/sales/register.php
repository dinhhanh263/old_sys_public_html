	...
	<div id="content">
		<div id="page-heading">
			<?php if(!isset($_POST['refund'])){ ?>
				<h1>商品販売レジ</h1>
				<p><a href="../help/register_manual/index.php" target="_blank">使い方ヘルプ</a></p>
			<?php }else{ ?>
				<h1>交換・返品処理</h1>
			<?php } ?>
					...
					<div id="content-table-inner">
						...
						<form action="" method="post" name="form1" id="form1" enctype="multipart/form-data">
							...
							<dl class="w350 half">
								...
								<dd>
									<select name="staff_id" class="styledselect_form_3" ><?php Reset_Select_Array_Group( getDatalistArray3("staff","shop_id") , ($sales['staff_id'] && !isset($_POST['refund'])) ? $sales['staff_id'] : $authority_staff['id'] ,getDatalist5("shop", $sales['shop_id'] ? $sales['shop_id'] : $authority_shop['id']));?></select>
								</dd>
								<dt class="regster_title">レジ担当</dt>
								<dd>
									<select name="rstaff_id" class="styledselect_form_3" ><?php Reset_Select_Array_Group( getDatalistArray3("staff","shop_id") , ($sales['rstaff_id'] && !isset($_POST['refund'])) ? $sales['rstaff_id'] : $authority_staff['id'] ,getDatalist5("shop", $sales['shop_id'] ? $sales['shop_id'] : $authority_shop['id']));?></select>
								</dd>
										...
										<?php
										 ...
										 ?>
											...
											<?php foreach ($product as $key => $value) { ?>
												<!-- <li>
													<span class="product_name_h"><?php echo $product_list[$value['product_no']]; ?></span>
													<span class="product_price_h">
														￥<?php echo number_format($value['price']); ?>（税込）×
														<span class="product_count_h"><?php echo $value['product_count']; ?></span>
													</span>
												</li> -->
											<?php } ?>
											</ul>
							...
							<dl class="w350 half <?php echo isset($_POST['refund']) ? 'history_area':'' ; ?>"><!-- 購入時支払方法 -->
								...
								<div class="btn-area2">
                                    ...
                                    <?php }else if($retouch_flg > 0){?><!-- システム権限か、購入後・当日のみ -->
											...
											<!-- 追加購入はこちら。
										<a class="button register_btn" href="../sales/register.php?customer_id=<?php echo $customer['id'].'&shop_id='.$sales['shop_id'].'&staff_id='.$sales['staff_id'].'&rstaff_id='.$sales['rstaff_id']?>">追加購入する</a> -->
									<?php } ?>
								</div>
									...
									<div id="related-activities">
										...
										<div id="related-act-bottom">
											...
											<div id="related-act-inner">
												...
												<div class="right">
													<h5><a href="javascript:void(0);" onclick="window.open('../../mpdf_register.php<?php echo $pdf_param;?>', 'mywindow4', 'width=900, height=1000, menubar=no, toolbar=no, scrollbars=yes');" class="side" title="領収書発行へ">領収書</a></h5>
												</div>
												<div class="clear"></div>
												<!-- 交換、返品処理制作中

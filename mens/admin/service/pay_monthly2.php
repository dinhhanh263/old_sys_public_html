...
<div id="content">
    ...
    <tr>
        ...
        <div id="content-table-inner">
            ...
            <div id="table-content">
              ...
              <form action="<?php echo($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="return check_form()">
                ...
                <tr>
                  ...
                  <td>
                    <select name="trade" style="height:25px;">
                        <option valus="カード毎月自動課金売上" <?php if($_POST['trade']=="カード毎月自動課金売上") echo "selected";?> >カード毎月自動課金売上</option>
                        <option valus="カード毎月自動課金エラー" <?php if($_POST['trade']=="カード毎月自動課金エラー") echo "selected";?> >カード毎月自動課金エラー</option>
                ...
                <tr>
                  ...
                  <td><select name="option_year" style="text-align:right;" class="inp-form" ><?php Reset_Select_Val( $gOptionYear , $option_year);?></select>年</td>
                </tr>
                <tr>
                  <td>※何月分支払代金:</td>
            ...
            <p><font color="red" size="-1">*　CSV形式： 取引日,取引, 名前（全角カナ）,金額, 名前（ローマ）,下４桁</font>

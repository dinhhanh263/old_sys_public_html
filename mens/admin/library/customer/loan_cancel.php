...
$from = "FROM contract_P AS tp,customer AS cs WHERE cs.id=tp.customer_id AND tp.del_flg =0 AND cs.del_flg =0 AND tp.status =7";
...
$dSql = "SELECT tp.*,cs.no as no,cs.name as name,cs.name_kana as name_kana,cs.tel as tel,cs.reg_date as reg_date ".$from.$dWhere."order by tp.contract_date LIMIT ".$dStart.",".$dLine_Max;

...
<?php include_once("../library/allowance/goal.php");?>
									...
									<form action="goal.php" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												...
												<td>
													<?php echo InputCheckboxTag7( "churn_all",$gChurnAll,$data['churn_all'],'',3);?>
												</td>
											</tr>
											<tr>
												<th valign="top">全店舗成約率:</th>
												<td>
													<?php echo InputCheckboxTag7( "contract_all",$gContractAll,$data['contract_all'],'',3);?>
												</td>
											</tr>
											<tr>
												<th valign="top">全店舗売上達成:</th>
												<td><?php echo InputCheckboxTag7( "sales_all",$gSalesAll,$data['sales_all'],'',3);?></td>
											</tr>

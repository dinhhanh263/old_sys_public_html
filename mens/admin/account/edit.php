								...
								<td>
									...
									<form action="" method="post" name="form1" enctype="multipart/form-data" onSubmit="return conf1('');">
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
												<th valign="top">店舗:</th>
												<td><select name="shop_id" style="height:25px;" <?php echo $authority_shop['id'] ? "disabled" : "" ?> ><?php Reset_Select_Key( $shop_list , $authority_shop['id'] ? $authority_shop['id'] : $data['shop_id'] );?></select>
</td>
											</tr> 
											<tr>
